    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#items_list').DataTable({
            ...
            stateLoadCallback: function(settings) {
                ...
                if (state_save_val) {
                    $('#search_item').val(state_save_val.search.search);
                }
            ...
            scrollCollapse: true,
            ajax: {
                url: url(laravel_routes['getItemList']),
                type: "GET",
                dataType: "json",
                data: function(d) {
            ...
            columns: [
                ...
                { data: 'mobile_no', name: 'items.mobile_no' },
                { data: 'email', name: 'items.email' },
            ],
...
app.component('itemForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        get_form_data_url = typeof($routeParams.id) == 'undefined' ? item_get_form_data_url : item_get_form_data_url + '/' + $routeParams.id;
        var self = this;
        self.hasPermission = HelperService.hasPermission;
        ...
        $scope.onSelectedCountry = function(id) {
            item_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                item_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            item_get_city_by_state = vendor_get_city_by_state
            $http.post(
                item_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
